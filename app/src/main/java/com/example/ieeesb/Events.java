...
public class Events extends AppCompatActivity {
    ...
    private TextView edit_text_view2;
    private static final String KEY_TITLE = "title";
    private static final String KEY_DESCRIPTION = "description";
    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private DocumentReference noteRef = db.document("Events/List");
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        edit_text_view2 = findViewById(R.id.edit_text_view_2);
        DocumentReference docRef = db.collection("Events").document("List");
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        }edit_text_view.setText(finalstring2 + "\n");
                        for(int i=0;i<10;i++){
                            String title1 = "event" + i;
                        ...
                        }edit_text_view2.setText(finalstring1 + "\n");
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()) {
                            ...
                            Toast.makeText(Events.this, "Document does not exist", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
